...
const ICONS = (() => {
  ...
  const M = {
    ...
    more: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" stroke="none"><circle cx="5" cy="12" r="1.8"/><circle cx="12" cy="12" r="1.8"/><circle cx="19" cy="12" r="1.8"/></svg>`,
